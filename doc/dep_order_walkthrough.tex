...
\title{Dependency-order differential compression\\
of the gapped suffix array}
\author{}
\date{}
...
For every interval with a preferred candidate of coverage \(\ge 2\),
...
if coverage \(\ge 2\), accepts it: pin the source ranks, mark covered
ranks removed.
