...
relative to GSA construction. Phase~II repeats enumeration,
snapshotting, and retarget attempts over successive dirty generations,
stopping at a fixed point or once a fixed iteration budget
(default~100) is spent, whichever comes first. It is the asymptotic
bottleneck on large instances, although in practice the fixed point is
reached after one or two generations; on the present toy example it is
a no-op.
