...
bench_repetition: src/bench_repetition.cpp src/shape.hpp src/gapped_sa.hpp src/sais.hpp src/compress.hpp src/serialize.hpp
	$(CXX) $(CXXFLAGS) $(INCLUDES) src/bench_repetition.cpp -o $@

simulate_repeats: src/simulate_repeats.cpp
